...
public class ModuleIOSpark implements ModuleIO {
        ...
        public ModuleIOSpark(int module) {
                ...
                driveSpark = new SparkFlex(swerveBaseID + swerveModuleIDsCount * module, MotorType.kBrushless);
                turnSpark = new SparkMax(swerveBaseID + 1 + swerveModuleIDsCount * module, MotorType.kBrushless);
        ...
        public void setDriveVelocity(double velocityRadPerSec) {
                double ffVolts = driveKs * Math.signum(velocityRadPerSec) + driveKv *
                                velocityRadPerSec;
